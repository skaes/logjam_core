...
If your application sets the global variable $user_id then logjam_logger will also log this info. One easy way to do this is to add a before_filter to your ApplicationController that looks something like this:
