...
module Parser
  ...
  def self.parse(stream) # :yields: request_info
    unprocessed_requests = {}
    stream.each_line do |line|
      begin
        unless parts = Matchers::LOG_LINE_SPLITTER.call(line)
      ...
      # we don't want to abort processing if a few lines raise exceptions
      rescue Exception => e
